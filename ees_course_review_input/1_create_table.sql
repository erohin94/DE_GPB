...
DROP TABLE IF EXISTS sandbox_hr.course_review_filtered_responses_tmp
/
CREATE TABLE IF NOT EXISTS sandbox_hr.course_review_filtered_responses_tmp (
...
DROP TABLE IF EXISTS sandbox_hr.course_review_recent_responses_tmp
/
CREATE TABLE IF NOT EXISTS sandbox_hr.course_review_recent_responses_tmp (
    response_id BIGINT COMMENT 'Уникальный идентификатор отзыва',
    response_date STRING COMMENT 'Дата и время отзыва',
    object_id BIGINT COMMENT 'Уникальный идентификатор курса',
    event_form STRING COMMENT 'Формат мероприятия в рамках курса',
...
DROP TABLE IF EXISTS sandbox_hr.course_review_final_responses_tmp
/
CREATE TABLE IF NOT EXISTS sandbox_hr.course_review_final_responses_tmp (
    response_id BIGINT COMMENT 'Уникальный идентификатор отзыва',
    response_date STRING COMMENT 'Дата и время отзыва',
    object_id BIGINT COMMENT 'Уникальный идентификатор курса',
    event_form STRING COMMENT 'Формат мероприятия в рамках курса',
...
DROP TABLE IF EXISTS sandbox_hr.ees_course_review_input
/
CREATE TABLE IF NOT EXISTS sandbox_hr.ees_course_review_input (
